    ...
    <section id="skills" className="section-pad border-t border-line bg-wash px-6">
      <SectionWrapper><div className="mx-auto max-w-6xl">
        <div className="grid gap-8 lg:grid-cols-[16rem_1fr] lg:gap-20">
          ...
          <div><h2 className="section-title">Tools I use to get from idea to working software.</h2><p className="mt-6 max-w-2xl text-lg leading-8 text-muted">My toolkit spans full-stack and mobile development, with the most depth in Python, Django, and API development.</p></div>
        </div>
